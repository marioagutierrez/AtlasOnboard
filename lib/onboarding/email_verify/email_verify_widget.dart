...
class EmailVerifyWidget extends StatefulWidget {
  const EmailVerifyWidget({Key? key}) : super(key: key);
...
class _EmailVerifyWidgetState extends State<EmailVerifyWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'emailVerify'});
                            ...
                            children: [
                              TextSpan(
                                text: FFLocalizations.of(context).getText(
                                  'zwcf4g6a' /* We have sent a verification li... */,
                                ),
                              ...
                              TextSpan(
                                text: FFLocalizations.of(context).getText(
                                  '8e8nhl42' /* , enter your email and touch t... */,
                                ),
                                style: TextStyle(),
                              )
                            ],
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'EMAIL_VERIFY_RESEND_E_MAIL_BTN_ON_TAP');
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'EMAIL_VERIFY_PAGE_LOG_IN_BTN_ON_TAP');
                            logFirebaseEvent('Button_auth');
