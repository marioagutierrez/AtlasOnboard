                                            ...
                                            Expanded(
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'abqn39l5' /* Enter your information to logi... */,
                                                ),
                                                style:
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'LOG_IN_PAGE_PAGE_Button-Login_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Button-Login_auth');
                                                              GoRouter.of(
                                                                      context)
                                                              ...
                                                              if (valueOrDefault<
                                                                ...
                                                                ScaffoldMessenger.of(
                                                                  ...
                                                                  SnackBar(
                                                                    content:
                                                                        Text(
                                                                      'Your role hasn\'t been assigned yet, you can\'t log in as admin yet',
                                                                      style:
                                                                          TextStyle(
                                                                        color: FlutterFlowTheme.of(context)
                                                                            .secondaryText,
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'LOG_IN_Button-ForgotPassword_ON_TAP');
                                                              logFirebaseEvent(
                                                              ...
                                                              Expanded(
                                                                child: Text(
                                                                  FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'spr98osj' /* Or use a social account to log... */,
                                                                  ),
                                                              ...
                                                              Expanded(
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'LOG_IN_Container_721bxz39_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Container_auth');
                                                                    GoRouter.of(
                                                                            context)
