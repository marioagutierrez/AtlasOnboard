...
DocumentReference? get currentUserReference =>
    loggedIn ? SofiaUsersRecord.collection.doc(currentUser!.uid) : null;

SofiaUsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : SofiaUsersRecord.getDocument(SofiaUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
