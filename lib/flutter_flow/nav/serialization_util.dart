  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case BeneficiaryRow:
            return BeneficiaryRow(data);
          case BoardMembersRow:
            return BoardMembersRow(data);
          case BankReferenceRow:
            return BankReferenceRow(data);
          case CommercialRecordAtlasRow:
            return CommercialRecordAtlasRow(data);
          case BeneficiaryAlternativeRow:
            return BeneficiaryAlternativeRow(data);
          case ReferralsRow:
            return ReferralsRow(data);
          case ProductsListRow:
            return ProductsListRow(data);
          case PepRow:
            return PepRow(data);
          case ProfileRecordAtlasRow:
            return ProfileRecordAtlasRow(data);
          case SignatoriesRow:
            return SignatoriesRow(data);
          case CommercialReferenceRow:
            return CommercialReferenceRow(data);
          case PersonalDocumentsRow:
            return PersonalDocumentsRow(data);
          case AdminAuthRow:
            return AdminAuthRow(data);
          default:
            return null;
        }
